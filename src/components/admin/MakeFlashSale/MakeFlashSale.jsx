...
import { makeDiscount } from '../../../Actions/products';
import { useSelector } from 'react-redux';

function MakeFlashSale({ id, isModalOpen, closeModal, productName, productPrice }) {
  ...
  const handleFlashSale = async (e) => {
    ...
    try {
      ...
      const response = await makeDiscount(info,token);
        ...
        <dialog id="my_modal_2" className="modal absolute h-full overlay-hidden z-999" open>
          <div className="modal-box  max-w-xl">
            <div className="card lg:card-side bg-base-100 ">
              <form onSubmit={handleFlashSale}>
                <div className="flex flex-col justify-center">
                  <h2 className="text-xl font-light mb-5">Make Flash Sale!</h2>
